export default function ProjectContact() {
  return (
    <section className="md:mx-[30px] mt-[70px] mb-[70px] md:mt-[140px] md:mb-[200px] text-center">
      <h4 className="mt-2 mb-2 text-3xl font-normal leading-[38px] md:leading-[46px]">
        Want to work together?
      </h4>
      <h5 className="text-gray-500 text-base font-normal leading-7">
